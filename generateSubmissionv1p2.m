...
kmToMile = unitsratio('km','mile');
feetToMeters = unitsratio('feet','meter');
...
for i = 1:1:totalFlights
    ...
    [totalArcLen, a12] = distance(CurrentLatitude(i), CurrentLongitude(i), FinalLatitude, FinalLongitude, E, 'degrees');
    totalDistanceKm = deg2km(totalArcLen);
